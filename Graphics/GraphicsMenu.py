...
if __name__ == "__main__":
    ...
    salary, commissions, sales, others = Data.load_data_incomes_from_excel('FILE.xlsx', 'Data')
    rent, transport, entertainment, services, personal_hygiene, insurance, debts, others = Data.load_data_expenses_from_excel('FILE.xlsx', 'Data')
    rent, transport, entertainment, services, personal_hygiene, insurance, debts, others = Data.load_data_budget_from_excel('FILE.xlsx', 'Data')
